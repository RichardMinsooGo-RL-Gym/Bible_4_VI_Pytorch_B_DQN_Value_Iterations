...
class Network(nn.Module):
    def __init__(self, state_size: int, action_size: int, 
        ...
        self.advantage_layer = NoisyLinear(128, action_size * atom_size)
    ...
    def dist(self, x: torch.Tensor) -> torch.Tensor:
        ...
        advantage = self.advantage_layer(adv_hid).view(
            -1, self.action_size, self.atom_size
        )
    ...
    def __init__(
        ...
        if self.use_n_step:
            ...
            self.memory_n = ReplayBuffer(
                state_size, memory_size, batch_size, n_step=n_step, gamma=gamma
            )
        ...
        self.dqn = Network(state_size, action_size, self.atom_size, self.support
                          ).to(self.device)
        self.dqn_target = Network(state_size, action_size, self.atom_size, self.support
                          ).to(self.device)
